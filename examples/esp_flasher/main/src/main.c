...
#define TARGET_RST_Pin 0
#define TARGET_IO0_Pin 1
...
int main(void)
{
    ...
    if (connect_to_target(HIGHER_BAUD_RATE) == ESP_LOADER_SUCCESS) {
        ...
        flash_binary(
            _home_nihao_w2T_github_esp_hosted_esp_hosted_ng_esp_esp_driver_network_adapter_merged_firmware_bin,
            _home_nihao_w2T_github_esp_hosted_esp_hosted_ng_esp_esp_driver_network_adapter_merged_firmware_bin_len,
            0x00);
