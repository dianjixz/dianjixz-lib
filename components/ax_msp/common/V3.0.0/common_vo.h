...
enum {
    SAMPLE_VO_SYNC_USER_0       = 0,
    SAMPLE_VO_SYNC_USER_1       = 1,
    SAMPLE_VO_SYNC_USER_2       = 2,
    SAMPLE_VO_SYNC_USER_CUSTUM  = 3,
    SAMPLE_VO_SYNC_USER_MAX     = 4,
};
