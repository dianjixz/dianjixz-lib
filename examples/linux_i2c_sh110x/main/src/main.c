...
int main(void)
{
	...
	printf("INTERFACE is i2c");
	printf("CONFIG_SDA_GPIO=%d",0);
	printf("CONFIG_SCL_GPIO=%d",0);
	printf("CONFIG_RESET_GPIO=%d",0);
	i2c_master_init(&dev, 0, 0, 0);
#endif // CONFIG_I2C_INTERFACE

#if CONFIG_SPI_INTERFACE
	printf("INTERFACE is SPI");
	printf("CONFIG_MOSI_GPIO=%d",CONFIG_MOSI_GPIO);
	printf("CONFIG_SCLK_GPIO=%d",CONFIG_SCLK_GPIO);
	printf("CONFIG_CS_GPIO=%d",CONFIG_CS_GPIO);
	printf("CONFIG_DC_GPIO=%d",CONFIG_DC_GPIO);
	printf("CONFIG_RESET_GPIO=%d",CONFIG_SPI_RESET_GPIO);
