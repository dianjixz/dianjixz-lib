...
/* station mode */
#define STATION_MODE_MAC_ADDRESS            "9c:9d:7e:ec:ac:da"
#define STATION_MODE_SSID                   "DIANJIXZ"
#define STATION_MODE_PWD                    "1234567890"
#define STATION_MODE_BSSID                  "9c:9d:7e:ec:ec:d0"
#define STATION_BAND_MODE                   BAND_MODE_AUTO
#define STATION_MODE_IS_WPA3_SUPPORTED      true
