...
#include "stdio.h"
#include "hdmi_io.h"
#define Timer0_Delay1ms Delay_ms
/******************************** debug *******************/
...
#define SPD_PKT_EN  0x04  // 9611 RX为MIPI，不需要发SPD_PKT
...
typedef enum PCRFormat { PCR_None, PCR_Standard, PCR_640x480_60Hz, PCR_1024x600_60Hz } PCRFormat;

typedef enum { I2S_2CH, I2S_8CH, SPDIF } _Audio_Input_Mode;
