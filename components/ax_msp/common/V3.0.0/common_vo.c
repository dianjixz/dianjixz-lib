...
static AX_VO_SYNC_INFO_T g_stSyncInfos[SAMPLE_VO_SYNC_USER_MAX] = {
    ...
    {.u16Vact = 800, .u16Vbb = 12, .u16Vfb = 28, .u16Hact = 1280, .u16Hbb = 68, .u16Hfb = 92, .u16Hpw = 20, .u16Vpw = 10, .u32Pclk = 74250, .bIdv = 1, .bIhs = 1, .bIvs = 1},
};
...
AX_S32 SAMPLE_COMM_VO_StartDev(SAMPLE_VO_DEV_CONFIG_S *pstVoDevConf)
{
    ...
    g_stSyncInfos[SAMPLE_VO_SYNC_USER_CUSTUM] = pstVoDevConf->stSyncInfos;
